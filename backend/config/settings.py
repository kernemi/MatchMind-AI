"""
Django settings for MatchMind AI project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'matchmind_db'),
        'USER': os.getenv('DB_USER', 'matchmind'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'matchmind_dev_password'),
